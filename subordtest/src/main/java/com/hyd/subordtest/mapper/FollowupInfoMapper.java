...
public interface FollowupInfoMapper {
    ...
    @Select("select * from V_Center2020_MedicationByFollowupInfo_Test where FollowupId = #{cd} and Type = '01'")
    List<Map<String, Object>> queryDrugListByFollowupId(String cd);

    @Select("select * from V_Center2020_MedicationByFollowupInfo_Test where FollowupId = #{cd} and Type = '02'")
