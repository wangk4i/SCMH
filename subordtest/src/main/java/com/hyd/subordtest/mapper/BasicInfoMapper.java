...
public interface BasicInfoMapper {
    ...
    @Select("select * from V_Center2020_BasicInfo_Test where ID = #{cd} and BasicInformationId is not null ")
    Map<String, Object> queryBasicInfoViewOfUpdate(String cd);

    @Select("select * from V_Center2020_BasicInfo_Test where ID = #{cd} and DelStatus ='DelLogo002' ")
    Map<String, Object> queryBasicInfoViewOfDelete(String cd);

    @Select("select * from V_Center2020_BasicInfo_Test where ID = #{cd} and DelStatus!='DelLogo001'")
