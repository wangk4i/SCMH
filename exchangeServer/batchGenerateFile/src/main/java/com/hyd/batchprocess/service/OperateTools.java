package com.hyd.batchprocess.service;

import com.google.gson.Gson;
import com.google.gson.GsonBuilder;
import com.hyd.batchprocess.domain.info.MessageInfo;
import com.hyd.batchprocess.domain.enumtion.OperateEnum;
import com.hyd.batchprocess.domain.info.XmlHeaderInfo;
import com.hyd.batchprocess.mapper.*;
import com.hyd.batchprocess.utils.LogUtil;
...
public class OperateTools {
     ...
     * @param info
     */
    public boolean delPatInfoToXml(MessageInfo info){
        //去数据库查询数据
        ...
        String xmlName = this.fileNumFromRedis();
     ...
     * @param info
     */
    public boolean restorePatInfoToXml(MessageInfo info){
     ...
     * @param info
     */
    public boolean turnDeathPatInfoToXml(MessageInfo info){
        //去数据库查询数据
    ...
    public boolean buildFollowupToXml(MessageInfo info){
        ...
        if (result.get("BasicInformationId")==null||result.get("v").equals("")){
