...
import com.hyd.batchprocess.domain.info.MsgBuildConf;
import com.hyd.batchprocess.domain.info.MsgBuildXml;
import com.hyd.batchprocess.utils.LogUtil;
import com.hyd.batchprocess.utils.XmlUtil;
    ...
    private boolean syncDocumentToXml(MessageInfo info){
        ...
        switch (info.getMsgaction()){
            ...
            case 2:
                ...
                break;
            case 3:
                suc = tools.delPatInfoToXml(info);
                break;
            case 4:
                // todo 年审
                break;
            case 5:
                suc = tools.restorePatInfoToXml(info);
                break;
            case 6:
                suc = tools.turnDeathPatInfoToXml(info);
                break;
            default:
                break;
        }
